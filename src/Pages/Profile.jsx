...
const Profile = () => {
    ...
    useEffect(() => {
        document.title = "Profile | LinguaConnect";
    }, []);
    ...
    return (
        <div className="min-h-screen flex flex-col items-center justify-center mb-10 mt-10">
            <div className="card bg-green-100 w-full max-w-md p-16 shadow-lg">
                ...
                <form onSubmit={handleUpdateProfile} className="mt-6">
                    ...
                    <button type="submit" className="btn btn-neutral bg-green-500 hover:bg-green-800 border-none mt-6 w-full">
                        Update Profile
                    </button>
                </form>
            </div>
